...
export const VisibilityIcon: React.FC<CustomIconsProps> = (props: CustomIconsProps) => {
    return (
        // бля так жопа горит из-за этой хуйни иконок? да ну, вроде бы тут не долго, если копировать все, в файлы это копируется нормально?
        // можем на примере этой иконки посмотреть? норм будет работать, просто заёба
        // покажи как делать копируешь svg и вставляешь в файл в паблик можно? нужно
        <svg className="md-icon" aria-hidden="true" viewBox="0 0 24 24" width={"1rem"} height={"1rem"} style={props.style}>
            {/* eslint-disable-next-line max-len */}
