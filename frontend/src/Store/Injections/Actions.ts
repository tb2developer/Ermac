...
// где ты будешь вызывать эту функцию? в компоненте кажется
// а что хранится в payload? чёто не то?
// SetInjectAutoInjectPayload - появляется и формируется после ответа от сервера. Ты хочешь его сформировать до.
// Два состояния - либо включен - либо нет/ da ponyal spasibo
